...
namespace ServerMDA.Controllers
{
    public class 電影movieController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("電影編號movieId,系列編號seriesId,中文標題titleCht,英文標題titleEng,上映年份releaseYear,上映日期releaseDate,最後上映日期releasedDate,片長runtime,電影分級編號ratingId,評分rate,期待度anticipation,票房boxOffice,劇情大綱plot")] 電影movie 電影movie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("電影編號movieId,系列編號seriesId,中文標題titleCht,英文標題titleEng,上映年份releaseYear,上映日期releaseDate,最後上映日期releasedDate,片長runtime,電影分級編號ratingId,評分rate,期待度anticipation,票房boxOffice,劇情大綱plot")] 電影movie 電影movie)
        {
